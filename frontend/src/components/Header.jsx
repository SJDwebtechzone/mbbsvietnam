...
const universities = [
  {
    ...
    slug: "university-of-health-and-sciences-vietnam national university",
  },
  {
    ...
    <header className="w-full font-sans">
      ...
      <div className="bg-[#CC1B1B] px-6 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-md bg-white/20 hover:bg-white/30 flex items-center justify-center text-white text-xs cursor-pointer transition">
            f
          </div>
          <div className="w-7 h-7 rounded-md bg-white/20 hover:bg-white/30 flex items-center justify-center text-white text-xs cursor-pointer transition">
            in
      ...
      <nav className="bg-white px-6 py-3 flex items-center justify-between shadow-md border-b-4 border-[#F5C518] relative z-40">
        ...
        <ul className="hidden lg:flex items-center gap-1">
          ...
          <li className="relative group">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 bg-white border border-red-100 border-t-2 border-t-[#CC1B1B] rounded-b-xl shadow-xl min-w-[260px] z-50 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-200">
