...
function HeroSection() {
  ...
  return (
    <>
      <section style={{ position: "relative", minHeight: "751px", display: "flex", alignItems: "center", overflow: "hidden" }}>
        {/* Background Image */}
        <div style={{ position: "absolute", inset: 0 }}>
          <img src={HeroImage1} alt="White Coat Ceremony – Nam Can Tho University"
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 48px", position: "relative", zIndex: 10, width: "100%" }}>
          <div style={{ maxWidth: 640 }}>
            <span style={{
              background: "#fecc00", color: "#6e5700", fontWeight: 900,
            ...
            <div style={{ borderLeft: "4px solid #c8102e", paddingLeft: 16, marginBottom: 36 }}>
              <p style={{ fontSize: 18, color: "#fff", fontWeight: 600, lineHeight: 1.7, margin: 0 }}>
        ...
        <div className="facts-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
          ...
          <div className="fact-span-2" style={{
            ...
            <div>
              ...
              <h3 className="font-headline" style={{ fontSize: 22, fontWeight: 900, marginBottom: 8, color: "#0f172a" }}>
                Established 2013
              </h3>
              <p style={{ color: "#334155", fontWeight: 600, lineHeight: 1.6, textAlign: "justify" }}>
          ...
          <div style={{ background: "#e0f2fe", padding: 32, borderRadius: 16, color: "#0c4a6e", border: "1px solid #bae6fd" }}>
            ...
            <h3 className="font-headline" style={{ fontSize: 22, fontWeight: 900, marginBottom: 8, color: "#0c4a6e" }}>Can Tho City</h3>
            <p style={{ fontSize: 14, color: "#0c4a6e", fontWeight: 600, lineHeight: 1.6, textAlign: "justify" }}>
          ...
          <div style={{ background: "#f0f4f8", padding: 32, borderRadius: 16, color: "#1e293b", border: "1px solid #cbd5e1" }}>
            ...
            <h3 className="font-headline" style={{ fontSize: 22, fontWeight: 900, marginBottom: 8, color: "#0f172a" }}>Private University</h3>
            <p style={{ fontSize: 14, color: "#1e293b", fontWeight: 600, lineHeight: 1.6, textAlign: "justify" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <div className="teaching-hospital-inner" style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 64 }}>
          ...
          <div style={{ flex: "1 1 400px", position: "relative" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
                ...
                <span style={{ fontWeight: 900, fontSize: 17 }}>Direct Clinical Access</span>
              </div>
          ...
          <div style={{ flex: "1 1 400px" }}>
            ...
            <p style={{ fontSize: 18, color: "#334155", fontWeight: 600, marginBottom: 32, lineHeight: 1.7, textAlign: "justify" }}>
  ...
  return (
    <section style={{ padding: "80px 0", background: "#f3f4f5" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", textAlign: "center", marginBottom: 64 }}>
        <h2 className="font-headline" style={{
          fontSize: "clamp(2rem, 3.5vw, 2.7rem)", fontWeight: 900,
          marginBottom: 16, color: "#CC1B1B",
        }}>
          World-Class Programs
        </h2>
        <p style={{ color: "#334155", fontWeight: 600, maxWidth: 480, margin: "0 auto" }}>
        ...
        {programs.map((prog, i) => (
          ...
          >
            ...
            <div style={{ padding: "0 24px 32px" }}>
              <h3 className="font-headline" style={{ fontSize: 22, fontWeight: 900, marginBottom: 12 }}>
                {prog.title}
              </h3>
              <p style={{ color: "#334155", fontSize: 14, fontWeight: 600, marginBottom: 24 }}>{prog.desc}</p>
    ...
    <section style={{ padding: "80px 0", background: "#fff" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <p style={{ color: "#334155", fontSize: 16, maxWidth: 480, margin: "0 auto", fontWeight: 600 }}>
        ...
        <div className="fee-layout" style={{ display: "flex", gap: 32, alignItems: "flex-start", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 420px", background: "#f8fafc", borderRadius: 16, overflow: "hidden", border: "1px solid #e2e8f0" }}>
            ...
            <div style={{ background: "#9e001f", padding: "20px 24px" }}>
              <h3 className="font-headline" style={{ color: "#fff", fontWeight: 800, fontSize: 15, margin: 0 }}>
            ...
            <div style={{ overflowX: "auto" }}>
              <div className="fee-table-scroll" style={{ minWidth: 420 }}>
                ...
                <div style={{
                  ...
                  fontSize: 11, fontWeight: 900, color: "#9e001f", textTransform: "uppercase", letterSpacing: "0.08em",
                }}>
                ...
                {semesterFees.map((row, i) => (
                  <div key={i} style={{
                    ...
                    <span style={{ fontWeight: row.year ? 900 : 500, fontSize: 13, color: row.year ? "#0f172a" : "transparent" }}>
                      {row.year || "—"}
                    </span>
                    <span style={{ fontSize: 13, color: "#334155", fontWeight: 600 }}>{row.sem}</span>
                    <span style={{ fontWeight: 800, color: "#9e001f", fontSize: 13 }}>{row.usd}</span>
                ...
                <div style={{
                  ...
                  <span style={{ fontWeight: 900, color: "#fff", fontSize: 14, gridColumn: "span 2" }}>Grand Total</span>
                  <span style={{ fontWeight: 900, color: "#fecc00", fontSize: 14 }}>$33,000</span>
                  <span style={{ fontWeight: 900, color: "#fecc00", fontSize: 14 }}>₹30,10,000</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ flex: "1 1 320px", display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{
              ...
              <h3 className="font-headline" style={{ fontWeight: 900, fontSize: 17, color: "#78350f", marginBottom: 4 }}>
                Payment Before Departure from India
              </h3>
              <p style={{ color: "#92400e", fontSize: 12, fontWeight: 600, marginBottom: 20 }}>One time charges for total 6 years</p>
              ...
              {departurePayments.map((item, i) => (
                <div key={item.label} style={{
                  ...
                  <span style={{ color: "#92400e", fontSize: 13, fontWeight: 600 }}>{item.label}</span>
                  <span style={{ fontWeight: 800, color: "#9e001f", fontSize: 14 }}>{item.amount}</span>
                </div>
              ))}
              ...
              <div style={{
                ...
                <span style={{ color: "#fecc00", fontWeight: 900, fontSize: 22 }}>₹7,93,000</span>
              </div>
            </div>
            ...
            <div style={{
              ...
              <h3 className="font-headline" style={{ fontWeight: 900, fontSize: 17, marginBottom: 4 }}>
                Food & Accommodation
              </h3>
              <div style={{ fontSize: 28, fontWeight: 900, color: "#15803d", marginBottom: 4 }}>$1,800</div>
              <div style={{ color: "#475569", fontSize: 13, fontWeight: 600, marginBottom: 12 }}>Approx ₹1,67,000 per year</div>
              <p style={{ color: "#166534", fontSize: 13, fontWeight: 600, lineHeight: 1.6 }}>
        ...
        <div style={{
          ...
          {services.map(service => (
            <div key={service} style={{
              ...
              <span style={{ color: "#1f2937", fontSize: 13, fontWeight: 700, lineHeight: 1.5 }}>{service}</span>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="student-life-inner" style={{
          ...
          <div style={{ flex: "1 1 420px", position: "relative", zIndex: 1 }}>
            <span style={{
              ...
              fontSize: 13, fontWeight: 900, padding: "8px 14px",
              borderRadius: 999, marginBottom: 20, letterSpacing: "0.04em", textTransform: "uppercase",
            }}>Student Lifestyle</span>

            <h2 style={{
              fontSize: "clamp(2.2rem, 3.5vw, 3rem)", fontWeight: 900, marginBottom: 24,
            ...
            <p style={{ fontSize: 16, color: "#334155", fontWeight: 600, marginBottom: 40, lineHeight: 1.8, maxWidth: 520 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
              {[
                ...
                <div key={stat.label} style={{
                  ...
                  <span style={{ fontSize: 30, fontWeight: 900, display: "block", marginBottom: 8, color: "#171b74" }}>
                    {stat.value}
                  </span>
                  <span style={{ fontSize: 12, textTransform: "uppercase", letterSpacing: "0.08em", color: "#6b7280", fontWeight: 700 }}>
                    {stat.label}
                  </span>
                </div>
              ))}
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ border: "2px dashed #e5bdbb", borderRadius: 24, padding: 32, background: "#fff" }}>
          <div style={{ display: "flex", alignItems: "flex-start", gap: 16, flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1 }}>
              <h3 className="font-headline" style={{ fontSize: 20, fontWeight: 900, marginBottom: 16, color: "#CC1B1B" }}>
              ...
              <p style={{ fontSize: 12, color: "#475569", fontWeight: 600, lineHeight: 1.7 }}>
      ...
      <section style={{
        ...
        <div style={{ width: "100%", textAlign: "center", position: "relative", zIndex: 2 }}>
          <span style={{
            ...
            fontWeight: 900, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 16,
          }}>2026 Admissions Open</span>

          <h2 style={{
            fontSize: "clamp(2.2rem,4.5vw,3.6rem)", fontWeight: 900, lineHeight: 1.15,
          ...
          <p style={{ maxWidth: 700, margin: "0 auto 28px", fontSize: 17, color: "#334155", fontWeight: 600, lineHeight: 1.8 }}>
          ...
          <div className="stats-grid-cta" style={{
            ...
            {[
              ...
              <div key={item.label} style={{ background: "#f9fafb", padding: 20, borderRadius: 18, border: "1px solid #e5e7eb" }}>
                <div style={{ fontSize: 30, fontWeight: 900, color: "#171b74", marginBottom: 6 }}>{item.value}</div>
                <div style={{ fontSize: 13, color: "#6b7280", fontWeight: 700 }}>{item.label}</div>
              </div>
            ))}
          </div>
        </div>
