        ...
        <div style={{ background: 'var(--surface)', color: 'var(--on-surface)' }}>
          <main style={{ paddingTop: '60px', paddingBottom: '48px' }}>
            ...
            <section style={{
              ...
              <div className="ctu-hero-grid" style={{
                maxWidth: '1280px',
                margin: '0 auto',
                display: 'grid',
                ...
                <div style={{
                  ...
                  <img
                    src={HeroImage}
                    alt="Nam Can Tho University classroom"
            ...
            <section style={{
              ...
              <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
                <div style={{
                  ...
                  <p style={{ color: '#49454F', fontSize: '14px', lineHeight: 1.5 }}>
                ...
                <div className="ctu-stats-grid" style={{
                  ...
                  {/* Card 1 - Students */}
                  <div className="stats-span-2" style={{
                    gridColumn: 'span 2',
            ...
            {/* About Section */}
            <section style={{ padding: '56px 24px', background: '#FFFBFE' }}>
              <div className="ctu-about-grid" style={{
                ...
                <div className="ctu-about-images" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', paddingTop: '24px' }}>
                    <img src={CanPic1} alt="medical lab" style={{ borderRadius: '14px', height: '200px', width: '100%', objectFit: 'cover' }} />
                    <img src={HeroImage1} alt="student plaza" style={{ borderRadius: '14px', height: '200px', width: '100%', objectFit: 'cover' }} />
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <img src={CanPic2} alt="campus view" style={{ borderRadius: '14px', height: '200px', width: '100%', objectFit: 'cover' }} />
                    <img src={CanPic3} alt="students" style={{ borderRadius: '14px', height: '200px', width: '100%', objectFit: 'cover' }} />
                  </div>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <div style={{ display: 'flex', gap: '16px', padding: '16px', borderRadius: '16px', transition: 'background 0.2s', cursor: 'pointer' }}>
                      <div style={{ background: 'rgba(179, 38, 30, 0.1)', padding: '12px', borderRadius: '12px', height: 'fit-content' }}>
                      ...
                      <div>
                        ...
                        <p style={{ fontSize: '14px', color: '#49454F' }}>Flexible academic structure allowing students to tailor their learning path effectively.</p>
                      </div>
                    </div>
                    <div style={{ display: 'flex', gap: '16px', padding: '16px', borderRadius: '16px', transition: 'background 0.2s', cursor: 'pointer' }}>
                      <div style={{ background: 'rgba(179, 38, 30, 0.1)', padding: '12px', borderRadius: '12px', height: 'fit-content' }}>
                      ...
                      <div>
                        ...
                        <p style={{ fontSize: '14px', color: '#49454F' }}>High-quality programs designed for international standards with significant English medium delivery.</p>
                      </div>
                    </div>
                  </div>
                  <div style={{
            ...
            <section style={{ padding: '56px 24px', background: '#F7F2FA' }}>
              <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '48px' }}>
                <div style={{ textAlign: 'center', maxWidth: '768px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  <h3 style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: 'clamp(24px, 4vw, 28px)', fontWeight: 700, color: '#CC1B1B' }}>Global Perspective, Local Heart</h3>
                  <p style={{ color: '#49454F', fontSize: '14px' }}>Integrating international standards within the peaceful atmosphere of Can Tho city.</p>
                </div>
                <div className="ctu-global-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
                  <div style={{ background: '#FFFFFF', borderRadius: '32px', padding: '28px', display: 'flex', flexDirection: 'column', gap: '20px', border: '1px solid rgba(202, 199, 208, 0.1)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <h4 style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: '18px', fontWeight: 700 }}>International Reach</h4>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                      ...
                      <span style={{ padding: '8px 16px', background: 'rgba(125, 82, 96, 0.1)', color: '#7D5260', fontSize: '12px', fontWeight: 700, borderRadius: '9999px' }}>EU PARTNERS</span>
                      <span style={{ padding: '8px 16px', background: 'rgba(125, 82, 96, 0.1)', color: '#7D5260', fontSize: '12px', fontWeight: 700, borderRadius: '9999px' }}>JAPANESE ALLIANCE</span>
                    </div>
                  </div>

                  <div style={{ background: '#FFFFFF', borderRadius: '32px', padding: '28px', display: 'flex', flexDirection: 'column', gap: '20px', border: '1px solid rgba(202, 199, 208, 0.1)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <h4 style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: '18px', fontWeight: 700 }}>Life in Can Tho</h4>
                      <span className="material-symbols-outlined" style={{ color: '#625B71', fontSize: '24px' }}>location_on</span>
                    </div>
                    <p style={{ color: '#49454F', lineHeight: 1.5, fontSize: '14px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '14px', fontWeight: 700, color: 'var(--on-surface)' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><span className="material-symbols-outlined" style={{ color: '#4CAF50', fontSize: '20px' }}>check_circle</span> Safe</div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><span className="material-symbols-outlined" style={{ color: '#4CAF50', fontSize: '20px' }}>check_circle</span> Affordable</div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><span className="material-symbols-outlined" style={{ color: '#4CAF50', fontSize: '20px' }}>check_circle</span> Scenic</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section style={{
              ...
              <div style={{ maxWidth: "1200px", margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2 }}>
                <div style={{ display: "inline-block", padding: "8px 18px", background: "#ffffff", color: "#B3261E", borderRadius: "999px", fontSize: "12px", fontWeight: "700", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "20px", boxShadow: "0 4px 18px rgba(0,0,0,0.06)" }}>Admissions Open 2026</div>

                <h2 className="ctu-cta-title" style={{ fontFamily: "Plus Jakarta Sans, sans-serif", fontSize: "clamp(32px, 5vw, 48px)", fontWeight: "800", color: "#CC1B1B", lineHeight: "1.2", marginBottom: "18px" }}>
                  Shape Your Future at <br /> Can Tho University
                </h2>

                <p style={{ maxWidth: "760px", margin: "0 auto", fontSize: "clamp(16px, 2vw, 18px)", color: "#49454F", lineHeight: "1.7", marginBottom: "36px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "16px" }}>
                  <button type="button" onClick={() => setIsModalOpen(true)} style={{ background: "#B3261E", color: "#fff", padding: "14px 30px", borderRadius: "14px", fontSize: "16px", fontWeight: "700", boxShadow: "0 10px 25px rgba(179,38,30,0.18)", cursor: "pointer" }}>
                    Apply Now
                  </button>
                  <button type="button" onClick={() => setIsModalOpen(true)} style={{ background: "#ffffff", color: "#1C1B1F", padding: "14px 30px", borderRadius: "14px", fontSize: "16px", fontWeight: "700", border: "1px solid #E0E0E0", cursor: "pointer" }}>
                    Get Free Guidance
                  </button>
                </div>
              </div>
