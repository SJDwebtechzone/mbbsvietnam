...
export default function BUHMedical() {
  ...
  const stats = [
    ...
    { icon: "medical_services", iconBg: "bg-red-100", iconColor: "text-red-700", title: "Specialized Medical Focus", subtitle: "100% Dedicated to Healthcare" },
      ...
      <div className="buh-page-container">
        ...
        <div className="bg-gray-50 text-gray-900 min-h-screen">
          <main className="pt-0 pb-24 md:pb-12">
            ...
            {/* ── HERO ── */}
            <section className="relative buh-hero min-h-[751px] flex items-center overflow-hidden mt-0">
              ...
              <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
                <div className="max-w-2xl">
                  <span className="inline-block px-4 py-1.5 rounded-full bg-yellow-200 text-yellow-900 text-xs font-black tracking-widest uppercase mb-6">
                    Established 2013
                  </span>
                  <h1 className="text-5xl md:text-7xl font-black text-white font-headline leading-[1.1] tracking-tight mb-6">
                    Buon Ma Thuot Medical University
                  </h1>
                  <p className="text-xl text-white font-semibold leading-relaxed mb-8 border-l-4 border-red-600 pl-6 text-justify">
            ...
            <section className="relative -mt-16 z-20 max-w-7xl mx-auto px-6">
              <div className="buh-stats-grid grid grid-cols-1 md:grid-cols-3 gap-6">
                {stats.map((stat) => (
                  <div key={stat.title} className="bg-white p-8 rounded-2xl flex items-center gap-6 shadow-2xl shadow-black/5 border border-slate-100">
                    ...
                    <div>
                      <h4 className="font-headline font-black text-gray-900 text-lg sm:text-xl">{stat.title}</h4>
                      <p className="text-slate-600 text-sm font-semibold mt-0.5">{stat.subtitle}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <section className="py-24 max-w-7xl mx-auto px-6">
              <div className="buh-about-grid flex flex-col md:flex-row gap-16 items-center">
                <div className="md:w-1/2">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-headline font-black text-[#CC1B1B] tracking-tight mb-6">Nurturing Excellence Since 2013</h2>
                  <p className="text-lg text-slate-700 leading-relaxed font-semibold mb-6 text-justify">
                  ...
                  <p className="text-lg text-slate-700 leading-relaxed font-semibold text-justify">
            ...
            <section className="py-24 bg-gray-100">
              <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-headline font-black text-[#CC1B1B] tracking-tight mb-4">Academic Programs</h2>
                  <p className="text-slate-600 text-base sm:text-lg font-semibold max-w-2xl mx-auto mb-8">Diverse healthcare specializations designed to meet international medical standards.</p>
                </div>
                <div className="buh-programs-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {programs.map((prog) => (
                    <div key={prog.title} className="bg-white p-8 rounded-2xl group hover:bg-red-700 transition-colors duration-300 border border-slate-200/60">
                      <MaterialIcon name={prog.icon} className="text-red-700 group-hover:text-white text-4xl mb-6 block" />
                      <h3 className="font-headline font-black text-xl sm:text-2xl mb-4 text-gray-900 group-hover:text-white">{prog.title}</h3>
                      <p className="text-sm sm:text-base text-slate-600 group-hover:text-white/90 leading-relaxed font-semibold">{prog.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <section className="py-24 max-w-7xl mx-auto px-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="order-1 md:order-2">
                  <div className="flex items-center gap-2 text-red-700 font-black tracking-wider uppercase mb-4">
                    <span className="w-8 h-[2px] bg-red-700 inline-block" /> Clinical Training
                  </div>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-headline font-black text-gray-900 tracking-tight mb-6">Hospital Exposure from Day One</h2>
                  <p className="text-lg text-slate-700 leading-relaxed font-semibold mb-8 text-justify">
            ...
            <section className="py-24 bg-gray-200/30">
              <div className="max-w-7xl mx-auto px-6">
                <div className="mb-16">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-headline font-black text-[#CC1B1B] tracking-tight mb-3">Modern Academic Infrastructure</h2>
                  <p className="text-slate-600 font-semibold">World-class facilities fueling research and medical mastery.</p>
                </div>
                    ...
                    <div key={idx} className={`${fac.colSpan} rounded-2xl overflow-hidden relative group`} style={{ minHeight: "200px" }}>
                      ...
                      <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 to-transparent">
                        <div className={fac.padding}>
                          <h4 className="text-white font-headline font-black text-lg sm:text-xl md:text-2xl">{fac.label}</h4>
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            <section className="py-16 sm:py-20 md:py-24 bg-white">
              <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="text-center mb-12 sm:mb-16">
                  ...
                  <p className="text-slate-600 text-base sm:text-lg font-semibold mt-3 max-w-2xl mx-auto leading-relaxed">
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                  ...
                  <div className="flex-1 bg-gray-50 rounded-2xl overflow-hidden border border-gray-200 shadow-sm">
                    ...
                    {/* Column Labels */}
                    <div className="grid grid-cols-3 bg-red-50 px-5 sm:px-7 py-3 text-xs font-black text-[#CC1B1B] uppercase tracking-wider border-b border-red-100">
                      <span>Year</span>
                      <span>USD (Fixed)</span>
                    ...
                    <div className="grid grid-cols-3 bg-[#CC1B1B] px-5 sm:px-7 py-4">
                      ...
                      <span className="font-black text-yellow-400 text-sm">$31,500</span>
                      <span className="font-black text-yellow-400 text-sm">₹28,76,236</span>
                    </div>
                    {/* Note */}
                  ...
                  <div className="flex-1 space-y-5">
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-5 sm:p-7 shadow-sm">
                      <h3 className="font-headline font-black text-base sm:text-lg text-yellow-900 mb-1.5">
                      ...
                      <div className="mt-4 bg-[#CC1B1B] rounded-xl p-4 flex justify-between items-center">
                        ...
                        <span className="text-yellow-400 font-black text-xl sm:text-2xl">₹8,46,853</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-2xl p-5 sm:p-7 shadow-sm">
                      ...
                      <div className="text-slate-600 text-xs sm:text-sm font-semibold mb-3">Approx ₹2,30,000 per year</div>
                ...
                <div className="mt-10 sm:mt-12">
                  <h3 className="font-headline text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 tracking-tight mb-6 text-center">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                    {[
                      ...
                      <div key={service} className="bg-gray-50 rounded-xl p-3 sm:p-4 flex items-start gap-3 border border-gray-200 shadow-sm">
                        <MaterialIcon name="check_circle" className="text-red-600 text-xl flex-shrink-0 mt-0.5" />
            ...
            {/* ── LOCATION ── */}
            <section className="py-24 max-w-7xl mx-auto px-6">
              <div className="bg-white rounded-[32px] overflow-hidden shadow-2xl flex flex-col md:flex-row border border-slate-200/60">
                <div className="md:w-1/2 p-12 md:p-20 flex flex-col justify-center">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-headline font-black text-[#CC1B1B] tracking-tight mb-6">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-100 border border-slate-200">
                    <MaterialIcon name="location_on" className="text-red-700 text-3xl" />
                    <div className="text-sm font-bold text-slate-800">Dak Lak Province, Central Highlands, Vietnam</div>
                  </div>
                </div>
            ...
            <section className="py-24 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-headline font-black text-[#CC1B1B] tracking-tight mb-8">Why Choose BUH?</h2>
                <div className="space-y-6">
                  {whyChoose.map((item) => (
                    <div key={item.num} className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-extrabold mb-1.5 text-base sm:text-lg text-slate-900">{item.title}</h4>
                        <p className="text-slate-600 text-sm sm:text-base font-semibold">{item.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-red-50 border-2 border-red-100 p-10 rounded-[2rem] relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 text-red-700 font-bold mb-6">
                    ...
                    <h3 className="font-headline text-xl font-black uppercase tracking-wider">Important Disclaimer</h3>
                  </div>
                  <p className="text-gray-900 leading-relaxed mb-6 font-bold">For International MBBS Aspirants:</p>
                  <ul className="space-y-4 text-slate-600 text-sm sm:text-base font-semibold">
                    {[
            ...
            <section className="w-full bg-gradient-to-r from-red-50 via-white to-pink-50 py-20 px-6">
              <div className="max-w-7xl mx-auto text-center">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-headline font-black text-gray-900 tracking-tight leading-tight mb-6">
                  Shape Your Future in Healthcare with BUH
                </h2>
                <p className="text-base sm:text-lg text-slate-700 max-w-3xl mx-auto leading-relaxed mb-10 text-justify md:text-center font-semibold">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <button onClick={() => setIsModalOpen(true)} className="bg-[#CC1B1B] hover:bg-red-800 text-white px-8 py-4 rounded-xl font-bold shadow-lg transition-all duration-300">
                    Apply Now
                  </button>
                  <a
                    href="https://bmu.edu.vn/"
                    target="_blank"
